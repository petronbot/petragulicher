				...
				<div id="mcs_container">
				    <div class="customScrollBox">
				        <div class="container">
				            <div class="content">
				            	<h5>DanceArama</h5>
				            	<p>Dancearam introduces  children to the world of dance and drama  in a happy and caring environment. The Dancearama classes are a fun, energetic fusion of Dance, Drama, Jazz, Tap and Ballet.</p>
				            	<p>Find out more at <a href="http://www.dancearama.com/" target="new">http://www.dancearama.com/</a></p>
				            	<p>&nbsp;</p>
				            </div>
				        </div>
