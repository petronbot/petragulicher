...
<div class="container">
	...
	<ul class="breadcrumbs">
		<li class="first"><a href="">Arts</a></li>
				...
				<div id="mcs_container">
				    <div class="customScrollBox">
				        <div class="container">
				            <div class="content">
				            	<h5>Dance</h5>
				            	<p>Dance is a particularly popular aspect of performing arts at Reddam House with a number of sizeable dance groups having been established ranging from hip-hop to classical. It is highly sought after as an enrichment subject in the Primary School and is offered as an elective subject right through to the Higher School Certificate.</p>
				            </div>
				        </div>
